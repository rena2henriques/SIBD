...
<body>
	...
	<form method="post" action="addregion.php" autocomplete="off">
		...
		<legend><strong>Add a new region:</strong></legend>
			...
			<input type="text" name="seriesid" autofocus style="width: 60%;"  maxlength="30" placeholder="Series ID" /><br></p>
			<p><strong>Element Index:</strong>
			<input type="text" name="elem_index" autofocus style="width: 50%;" maxlength="30" placeholder="Element Index"/><br></p>
			<p><strong>X1:</strong>
